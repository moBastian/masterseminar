# -*- encoding : utf-8 -*-
#Seeds für den Tiere&Pflanzen-Test
...
question_n4 = [
		...
		"Welcher dieser Pilze ist essbar?",
		"Welcher dieser Pilze ist essbar?",
		"Bei wieviel Grad Celsius während der Wachstumsphasen endet das Baumwachstum?",
		"Wie heißt die kälte- bzw. höhenbedingte Grenze an der Bäume nicht mehr wachsen?",
		"Wie nennt man eine dunkle Pigmentierung von Haut Haaren etc. durch Melanine?",
		"Wie nennt man das Fehlen von Farbstoffen in Haut Haaren etc.?",
		"Wie nennt man Vögel, deren Brutgebiete und Winterquartiere weit voneinander entfernt sind?",
		"Wie heißen die kleinsten bekannten Vögel?",
		"Wie nennt man Vogelarten, die sofort nach dem Schlüpfen das Nest verlassen?",
		"Woraus bestehen Vogelfedern maßgeblich?",
		"Wieviele Extremitäten sind charakteristisch für Vögel?",
		"Wodurch wird Vogelgefieder wasserabweisend?",
		"Welcher dieser Vögel kann nicht fliegen?",
		"Welcher dieser Vögel kann nicht fliegen?",
		"Wie nennt man die von Fischen im Wasser abgelegten Eier?",
		"Mithilfe welches Organs können Fische im Wasser schweben?",
		"Welche Gebilde finden sich häufig auf der Körperhülle von Fischen?",
		"Welchen dieser Fische gibt es wirklich?",
		"Welche dieser Flossen kommt paarweise vor?",
		"Welcher dieser Fische betreibt Kannibalismus?",
		"Welches dieser Tiere ist kein Fisch?",
		"Welcher dieser Fische lebt in der Tiefsee?",
		"Welche Farbe hat ein Rappe hauptsächlich?",
		...
		"Wie heißt die schwarz-weiß gestreifte afrikanische Pferdeart?",
		"Um ein Pferd anzutreiben, gibt ihm der Reiter die…?",
		"Wieviele Zehen hat eine Hundepfote?",
		"Welche dieser Hunderassen zählt zu den schnellsten der Welt?",
		"Wie heißen die Jungtiere von Hunden?",
		"Wie werden männliche Hunde genannt?",
		"Wie nennt man das Langhaar männlicher Löwen?",
		"Für welche dieser Raubkatzen ist gestreiftes Fell charakteristisch?",
		"Löwen organisieren sich meist als…?",
		"Als schnellste Raubkatze der Welt gilt der...?",
		"Bis zu wieviele Tonnen wiegen (afrikanische) Elefanten?",
		"Die Stoßzähne von Elefanten bestehen aus…?",
		"Die lange Nase von Elefanten heißt?",
		"Elefanten sind…?",
		"Wo finden sich Pinguine?",
		"Wo befindet sich der natürliche Lebensraum von Tigern?",
		"Wo leben Löwen hauptsächlich?",
		"Auf welchem Kontinent sind fast überall Amseln anzutreffen?",
		"Wo überwintern die Weißstörche Europas?",
		"Grottenolme finden sich in…?",
		"In welchem dieser europäischen Länder sind Braunbären heimisch?",
		"In welcher dieser Gegenden befinden sich Eisbären?",
...
item_alternatives_n4 = [
		...
		%w{Reisevögel Zugvögel Weitvögel Windvögel},
		%w{Kolibri Albatros Fregattvogel Taube},
		%w{Nesthocker Nestsitzer Nestflüchter Nestspringer},
		%w{Chinin Chitin Holz Keratin},
		%w{2 4 6 8},
		%w{Proteine Zucker Fette Plastik},
		%w{Meise Pinguin Eisvogel Möwe},
		%w{Strauß Pfau Amsel Sperling},
		%w{Laich Lauch Lurch Leder},
		%w{Luftblase Schwimmblase Seifenblase Leber},
		%w{Flechten Federn Schuppen Pilze},
		%w{Regenbogenlachs Regenbogenthunfisch Regenbogenmatjes Regenbogenforelle},
		%w{Brustflosse Schwanzflosse Rückenflosse Afterflosse},
		%w{Barsch Hecht Forelle Karpfen},
		%w{Hammerhai Lachs Delfin Walhai},
		%w{Barsch Karpfen Hecht Anglerfisch},
		%w{schwarz weiß braun grau},
		%w{Hengst Walach Stute Fohlen},
		%w{Hengst Walach Stute Fohlen},
		%w{Fische Amphibien Insekten Säugetieren},
		%w{Unpaarhufer Paarhufer Vielhufer Vierhufer},
		%w{Fuchs Schimmel Rappe Wolke},
		%w{Tiger Panda Zebra Dalmatiner},
		%w{Lassos Karotten Komplimente Sporen},
		%w{5 6 2 4},
		%w{Yorkshire\ Terrier Zwergspitz Pudel Englischer\ Windhund},
		%w{Wespe Vespa Welpe Fohlen},
		%w{Prüde Rüde Hengst Eber},
		%w{Mähne Friese Köten Schweif},
		%w{Löwe Tiger Gepard Leopard},
		%w{Familie Rotte Rudel Herde},
		%w{Leopard Löwe Tiger Gepard},
		%w{4 6 12 14},
		%w{Elfenbein Zwergenbein Orkbein Holzbein},
		%w{Schaufel Riecher Rüssel Knolle},
		%w{Reptilien Amphibien Insekten Säugetiere},
		%w{Arktis Antarktis Nordsee Mittelmeer},
		%w{Afrika Amerika Asien Europa},
		%w{Afrika Amerika Asien Europa},
		%w{Afrika Europa Amerika Australien},
		%w{Afrika Australien Amerika Mallorca},
		%w{Waldbächen Höhlengewässern Salzgewässern Mooren},
		%w{Belgien Irland Schweden Schweiz},
		%w{Antarktis Feuerland Neuseeland Arktis},
		%w{2 4 6 8},
...
t = Test.create(name: "Tiere&Pflanzen",  info: "Tiere&Pflanzen-Test", short_info: "Tiere&Pflanzen-Test",len: 1, time: 900, subject: "MasterSem17-18", picture: "/images/Logos/tier_pflanze.png", construct: "Probe")
