...
t = Test.create(name: "Geschichtstest",  info: "Geschichtstest", short_info: "Geschichtstest",len: 1, time: 900, subject: "Geschichte", picture: "/images/mathe.png", construct: "Probe", student_access:true, archive: false)
