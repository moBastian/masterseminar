...
question_n4 = [
		...
		"Welcher dieser Flüsse mündet am Deutschen Eck in den Rhein?",
		"Durch welches dieser Bundesländer fließt der Main nicht?",
		...
		"Wie heißt der bekannteste Inselberg Australiens?",
		"Der südliche Mittelmeerraum sowie Nordafrika gehören zu welcher Klimazone?",
		"Der Großteil Europas gehört zu welcher Klimazone?",
		"Zu welcher Klimazone gehören Arktis und Antarktis?",
		"Um den Äquator erstreckt sich welche Klimazone?",
		"In welchem Ozean zirkuliert der Golfstrom?",
		"Woher leitet sich der Name des Golfstroms ab?",
		"Was ist der Golfstrom?",
		"Wie groß ist der Einfluss des Golfstroms auf das europäische Klima laut neuerer Forschung?",
		"Wie nennt man Boden der das ganze Jahr hinweg gefroren ist?",
		"In welchem dieser Gebiete bzw. Länder finden sich große Flächen von Permafrostboden?",
		"In welchem dieser Länder finden sich große Flächen von Permafrostboden?",
		"In welchem dieser Länder finden sich große Flächen von Permafrostboden?",
		"Wie nennt man die Kaltphase zwischen dem 15. und 19. Jahrhundert in Europa?",
		"Wie viele Jahre dauerte die letzte Eiszeit in Europa, die vor etwa 10.000 Jahren endete?",
		"Das Gebiet welcher dieser Städte war während der letzten Eiszeit in Europa nicht komplett von Inlandeis überzogen?",
		"Ab welcher Temperatur schmilzt Eis (unter Normalbedingungen)?",
		"Welche Meerenge verbindet Mittelmeer und Atlantik?",
		"Welche Meerenge verbindet Marmarameer und Schwarzes Meer?",
		"Welche Meerenge verbindet Marmarameer und Ägäis?",
		"Welche Meerenge verbindet Mittelmeer und Rotes Meer?",
		"Welcher dieser Staaten ist kein Mittelmeeranrainer?",
		"Welcher dieser Staaten ist kein Mittelmeeranrainer?",
		"Welcher dieser Erdteile grenzt nicht ans Mittelmeer?",
		"Welche dieser Inseln liegt im Mittelmeer?",
		"Welcher dieser Staaten gehört nicht zum Baltikum?",
		"Welcher dieser Staaten hat die längste Ostseeküste?",
		"Welche dieser Inseln liegt nicht in der Ostsee?",
		"Welche dieser Inseln liegt nicht in der Ostsee?",
		"Wie viele Meter tief ist die Ostsee an ihrer tiefsten Stelle?",
		"Welcher dieser Flüsse mündet nicht in die Ostsee?",
		"Welcher dieser Flüsse mündet in die Ostsee?",
		"Welche europäische Hauptstadt liegt am Öresund?",
		"Wie heißt die Gezeitenphase, in der durch abfließendes Wasser der Meeresspiegel absinkt?",
		"Welche Gezeitenphase ist von steigendem Wasserspiegel geprägt?",
		"Die Gezeitenkräfte welches Himmelskörpers wirken sich am Stärksten auf der Erde aus?",
		"Wie nennt man das bei Ebbe trockengelegte Land?",
		"Welches dieser Länder ist kein Nordseeanrainer?",
		"Welches dieser Länder ist kein Nordseeanrainer?",
		"In der Wirtschaftszone welches Landes stehen die meisten Erdöl-Plattformen der Nordsee?",
		"In der Wirtschaftszone welches Landes werden die meisten Erdölreserven der Nordsee vermutet?",
		"Welches dieser deutschen Mittelgebirge ist am nördlichsten gelegen?",
		"Welches dieser deutschen Mittelgebirge erstreckt sich am weitesten nach Osten?",
		"Wie heißt der höchste Berg im Harz?",
		"Welches dieser Gebirge liegt (unter anderem) in Rheinland-Pfalz?",
...
item_alternatives_n4 = [%w{Erde Sonne Mond Mars},
												%w{Kieler\ Woche Travemünder\ Woche Hamburger\ Hafengeburtstag Hafentage\ Husum},
												%w{Donau Main Mosel Thur},
												%w{Bayern Bremen Hessen Baden-Württemberg},
												...
												%w{Mount\ Tabor Wase\ Rock Mulanje\ Massif Uluru\ (Ayers\ Rock)},
												%w{Polargebiete Gemäßigte\ Zone Subtropen Tropen},
												%w{Polargebiete Gemäßigte\ Zone Subtropen Tropen},
												%w{Polargebiete Gemäßigte\ Zone Subtropen Tropen},
												%w{Polargebiete Gemäßigte\ Zone Subtropen Tropen},
												...
												%w{Mexiko Chile Indonesien Kanada},
												%w{Kleine\ Eiszeit Langer\ Winter Ewiges\ Eis Permafrost},
												%w{10 100 1000 100.000},
												%w{Kiel Hamburg Rostock Berlin},
												%w{100°C 4°C 0°C 0°K},
												%w{Bosporus Dardanellen Suezkanal Straße\ von\ Gibraltar},
												%w{Bosporus Dardanellen Suezkanal Straße\ von\ Gibraltar},
												%w{Bosporus Dardanellen Suezkanal Straße\ von\ Gibraltar},
												%w{Bosporus Dardanellen Suezkanal Straße\ von\ Gibraltar},
												%w{Frankreich Italien Portugal Spanien},
												%w{Andorra Frankreich Italien Monaco},
												%w{Nordafrika Nordeuropa Südeuropa Vorderasien},
												%w{Borneo Kuba  Grönland Zypern},
												%w{Estland Lettland Litauen Moldawien},
												%w{Deutschland Schweden Russland Estland},
												%w{Fehmarn Rügen Sylt Usedom},
												%w{Föhr Hiddensee Poel Ummanz},
												%w{127 289 459 1107},
												%w{Elbe Memel Oder Weichsel},
												%w{Donau Elbe Main Oder},
												%w{Helsinki Kopenhagen Malmö Paris},
												%w{Ebbe Flut Tide Watt},
												%w{Ebbe Flut Tide Watt},
												%w{Mars Merkur Mond Sonne},
												%w{Ebbe Flut Tide Watt},
												%w{Belgien Deutschland Luxemburg Niederlande},
												%w{Dänemark Finnland Norwegen Schweden},
												%w{Dänemark Deutschland Vereinigtes\ Königreich Norwegen},
												%w{Dänemark Deutschland Vereinigtes\ Königreich Norwegen},
												%w{Bayerischer\ Wald Erzgebirge Hunsrück Teutoburger\ Wald},
												%w{Eifel Erzgebirge Odenwald Schwarzwald},
												%w{Brocken Feldberg Fichtelberg Tanngipfel},
...
t = Test.create(name: "Geographie",  info: "Geographietest", short_info: "Geographietest",len: 1, time: 900, subject: "MasterSem17-18", picture: "/images/Logos/welt.png", construct: "Probe")
