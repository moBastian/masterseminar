...
question_n4 = [
		...
		"Welches dieser Länder ist nicht unter den Top-3 des ewigen Medaillenspiegels der Olympischen Winterspiele?",
		"Welche Nation führt den ewigen Medaillenspiegel der Olympischen Spiele an?",
		"Welche dieser Medaillen werden bei Olympischen Spielen nicht vergeben?",
		"Womit werden die besten Teilnehmer bei olympischen Spielen ausgezeichnet?",
		"In welchem Land fanden die Olympischen Winterspiele 2018 statt?",
		"Wie hieß der Austragungsort der Olympischen Winterspiele 2018?",
		"Was müssen Sportler erfüllen um an olympischen Spielen Teilzunehmen?",
		"Welche dieser Sportarten war bei den Olympischen Spielen 2018 nicht vertreten?",
		"Welche dieser Sportarten war bei den Olympischen Spielen 2018 nicht vertreten?",
		"Erfolgreichste Nation bei den Olympischen Winterspielen 2018 war?",
		"Unter der Flagge welchen Landes durften 2018 keine Athleten an den olympischen Spielen teilnehmen?",
		"Wann fand die letzte Fußball-WM in Deutschland statt?",
		"Wann fand die erste Fußball-WM in Deutschland statt?",
		"In welchem Jahr nahm Deutschland erstmals an einer Fußball-WM teil?",
		"In welchem dieser Jahre wurde Deutschland nicht Fußball-Weltmeister?",
		"Welche Fußballnationalmannschaft hat die meisten WM-Titel?",
		"Wieviele Fünfecke befinden sich auf der Oberfläche eines Fußballs?",
		"Wieviele Sechsecke befinden sich auf der Oberfläche eines Fußballs?",
		"Die Vereinigung europäischer Fußballverbände kennt man unter welcher Abkürzung?",
		"Die Fußball-Regionalligen bilden in der Hierarchie des deutschen Meisterschaftssystems die wievielte Liga?",
		"Wie heißen die Spiele der drittletzten Mannschaft der 1. Bundeliga und der dritten Mannschaft der 2. Bundesliga?",
		"Wieviele Spieltage umfasst eine Bundesligasaison (Stand 2017/18)?",
		"Wieviele Punkte bekommen beide Fußball-Mannschaften bei einem Unentschieden?",
		"Welcher dieser Vereine war in der Saison 2017/18 nicht Teil der 1. Bundesliga?",
		"Welcher dieser Vereine stieg zur Saison 2017/18 in die 1. Bundesliga auf?",
		"Welche Fußballmannschaft wurde bisher am häufigsten Deutscher Meister?",
		"Welcher deutsche Fußballspieler ist mit 365 Toren in 427 Spielen der erfolgreichste Bundesliga-Torschütze?",
		"Neben 29 US-Mannschaften spielt ein kanadisches Team in der NBA Basketball - welches?",
		"Bei welcher NBA-Mannschaft spielt Dirk Nowitzki seit seinem Wechsel in die USA?",
		"Basketball-Legende Michael Jordan verbrachte den Großteil seiner NBA-Profikarriere als Spieler bei den...?",
		"Auf wieviel Metern Höhe hängen die Körbe beim Basketball?",
		"Wieviele Spieler (Feldspieler und Auswechselspieler) sind pro Mannschaft an einem Basketballspiel beteiligt?",
		"Trifft ein Basketballspieler bei einem Freiwurf, dann erhält seine Mannschaft wieviele Punkte?",
		"Wieviele Meter ist ein (gemäß FIBA offizielles) Basketballspielfeld groß?",
		"Ein Basketballspiel ist eingeteilt in…?",
		"Welche Kennzahl dient dazu das Spielpotenzial eines Golfers zu beschreiben?",
		...
		"Wie viele Meter ist ein Volleyballfeld groß?",
		"Wieviele Volleyballspieler stehen pro Mannschaft auf dem Feld?",
		"Wie oft darf ein Volleyball von einer Mannschaft berührt werden, bis er zur gegnerischen Mannschaft gespielt werden muss?",
		"Mittels welches Schlages wird der Ball beim Volleyball ins Spiel gebracht?",
		"Mit mindestens zwei Punkten Abstand und wievielen Punkten gewinnt man im Tischtennis einen Satz?",
		"Wieviele cm muss ein Tischtennisball beim Aufschlag mindestens hochgeworfen werden?",
		"Wie heißt Tischtennis u.a. in China?",
		"Wo nahm Tischtennis Ende des 19. Jahrhunderts seinen Anfang?",
		"Welche dieser Sportarten gehört nicht zu einem Triathlon?",
		"Welche dieser Sportarten gehört zum Biathlon?",
		"Welche dieser Sportarten gehört zum Biathlon?",
		"Welche dieser Sportarten gehört zur Nordischen Kombination?",
		"Welche dieser Sportarten gehört zur Nordischen Kombination?",
		"Welche dieser Disziplinen findet nicht auf dem Eis statt?",
		...
		"Wieviele Objektbälle (also weder Spielball, noch die roten Kugeln) gibt es in einer Snookerpartie?",
		"Die Kugel welcher Farbe liegt in der Mitte des Snookertisches zu Beginn einer Partie?",
		"Wie lautet das Verhältnis von Länge zu Breite bei einem Billardtisch?",
		"Wieviele Pins gilt es beim Bowling mit der Kugel umzustoßen?",
		"Wieviele Meter ist eine Bowlingbahn lang?",
		"Bowling ist eine Variante welches Präzisionssports?",
		"Räumt man alle 10 Pins beim Bowling beim ersten Wurf ab, so nennt man dies?",
		"Welche dieser Disziplinen ist keine olympische Leichtathletik-Disziplin?",
		"Welche der folgenden Distanzen ist unüblich für Sprintdisziplinen der Leichtathletik?",
		"Wieviel Gramm wiegt ein Speer beim Speerwerfen der Männer?",
		"Wieviel Gramm wiegt ein Speer beim Speerwerfen der Frauen?",
		"Welches Formel-1-Team holte bisher die meisten Titel in der Konstrukteurswertung?",
		"Welches Team gewann 1950 die erste Formel-1-Weltmeisterschaft?",
		"Wie heißt der erfolgreichste Fahrer der Formel-1-Geschichte?",
		"Wieviele Weltmeistertitel holte Michael Schumacher in seiner Formel-1-Karriere?",
		"Wie sieht die Flagge aus, die den Zieleinlauf bei einem Formel-1-Rennen markiert?",
		"Wieviele Punkte erhält der Sieger eines DTM-Rennens seit 2012?",
		"Wer wurde 2017 Meister der DTM? ",
		"Welches Team holte 2017 die DTM Meisterschaft?",
		"Wer stellte 2008 und 2009 seinen eigenen 100-Meter-Lauf-Rekord zweimal selbst ein?",
		"Den Weltrekord im Hammerwurf der Frauen hält mit 82,98 Metern?",
		"Wer hält den Schwimm-Weltrekord für 100m Schmetterling der Herren?",
		"Aus welchem Land stammt Kylie Masse, die den Schwimm-Weltrekord für 100m Rücken der Frauen hält?",
...
item_alternatives_n4 = [
		...
		%w{Deutschland Russland Norwegen USA},
		%w{Deutschland Russland USA China},
		%w{Blechmedaille Goldmedaille Silbermedaille Bronzemedaille},
		%w{Medaille Pokal Lorbeerkranz Krone},
		%w{Vietnam Südkorea Japan Sri\ Lanka},
		%w{Gangnam Pjöngjang Pyeongchang Peking},
		%w{Mindestaktivität Mindesterfahrung Höchstalter Olympische\ Norm},
		%w{Biathlon Triathlon Eiskunstlauf Snowboard},
		%w{Bob Curling Rennrodeln Schwimmen},
		%w{Deutschland USA Norwegen Kanada},
		%w{Russland Ukraine China Marokko},
		%w{1954 1974 2006 2010},
		%w{1930 1954 1966 1974},
		%w{1930 1934 1950 1954},
		%w{1950 1954 1974 1990},
		%w{Brasilien Deutschland Italien Argentinien},
		%w{0 1 12 20},
		%w{0 1 12 20},
		%w{FIFA UEFA IOC NOK},
		%w{Erste Zweite Dritte Vierte},
		%w{Delegation Verifikation Relegation Summation},
		%w{24 34 43 44},
		%w{1 2 3 0},
		%w{Dynamo\ Dresden FC\ Augsburg Eintracht\ Frankfurt RB\ Leipzig},
		%w{VfL\ Wolfsburg VfB\ Stuttgart RB\ Leipzig Hannover\ 96},
		%w{1.\ FC\ Köln Borussia\ Dortmund FC\ Bayern\ München Werder\ Bremen},
		%w{Klaus\ Fischer Jupp\ Heynckes Dieter\ Müller Gerd\ Müller},
		...
		%w{18x9 23x8 28x15 120x90},
		%w{5 6 7 8},
		%w{gar\ nicht einmal zweimal dreimal},
		%w{Abstoß Freistoß Aufschlag Einwurf},
		%w{7 9 11 13},
		%w{8 16 32 64},
		%w{Ping\ Pong\ Ball Ping Pong Nandai},
		%w{China Japan Italien England},
		%w{Schwimmen Radfahren Laufen Rudern},
		%w{Skilanglauf Skispringen Riesenslalom Abfahrtslauf},
		%w{Speerwurf Schießen Bogenschießen Hammerwurf},
		%w{Shorttrack Riesenslalom Skilanglauf Abfahrtslauf},
		...
		%w{400 600 800 1000},
		%w{400 600 800 1000},
		%w{Ferrari Williams McLaren Mercedes},
		%w{Ferrari Alfa\ Romeo Mercedes Maserati},
		%w{Hamilton Vettel Prost Schumacher},
		%w{4 5 7 8},
		%w{schwarz-weiß\ kariert blau gelb rot},
		%w{10 15 20 25},
		%w{Pascal\ Wehrlein Marco\ Wittmann René\ Rast Timo\ Schneider},
		%w{BMW Audi Mercedes-Benz Opel},
		%w{Carl\ Lewis Donovan\ Bailey Asafa\ Powell Usain\ Bolt},
		%w{Anita\ Wlodarczyk Betty\ Heidler Mihaela\ Melinte Tatjana\ Lyssenko},
		%w{Aaron\ Peirsol Michael\ Phelps Ryan\ Lochte Adam\ Peaty},
		%w{China USA Kanada Schweden},
